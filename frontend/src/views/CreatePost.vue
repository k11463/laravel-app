<template>
  <div class="box">
    <v-row>
      ...
      <v-col lg="6">
        <v-card>
          <v-card-title style="font-weight: bold">新增文章</v-card-title>
          <v-divider></v-divider>
          <v-container fluid>
            ...
            <v-row>
              <v-col lg="2" class="center">
                <v-btn @click="$router.back()">取消新增</v-btn>
              </v-col>
              <v-col lg="8"></v-col>
              <v-col lg="2" class="center">
                <v-btn @click="CreatePost">新增文章</v-btn>
              </v-col>
            </v-row>
          </v-container>
        </v-card>
  ...
  computed: {
    GetImage() {
      if (this.imageFile.file != null) {
        ...
        return "http://localhost:8000/storage/cover.jpg";
      }
    },
  },
};
